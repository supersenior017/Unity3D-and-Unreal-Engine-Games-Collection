...
public class Upgrade_Ghosty : MonoBehaviour
{
    ...
    public Sprite Sprite_Upgrade_4;
    public Sprite Sprite_Upgrade_5;
    ...
    public void Upgrade()
    {
        ...
        if (txt.text == "Ghosty (0)" && Count_Souls >= 1000)
        {
            Upgrade_1(txt, img, Count_Souls);
        }
        //check if Cloud Wall already has been upgraded once and if enough Souls are available
        else if (txt.text == "Ghosty (1)" && Count_Souls >= 2500)
        {
            Upgrade_2(txt, img, Count_Souls);
        }
        else if (txt.text == "Ghosty (2)" && Count_Souls >= 5000)
        {
            Upgrade_3(txt, img, Count_Souls);
        }
        else if (txt.text == "Ghosty (3)" && Count_Souls >= 10000)
        {
            Upgrade_4(txt, img, Count_Souls);
        }
        else if (txt.text == "Ghosty (4)" && Count_Souls >= 20000)
        {
            Upgrade_5(txt, img, Count_Souls);
        }
    }
    ...
    void Upgrade_1(Text txt, Image img, int Count_Souls)
    {
        ...
        txt.text = "Ghosty (1)"; //set Text of Button to ...
    ...
    {
        int Souls_after_Upgrade;
        txt.text = "Ghosty (2)"; //set Text of Button to ...
    ...
    {
        int Souls_after_Upgrade;
        txt.text = "Ghosty (3)"; //set Text of Button to ...
    ...
    void Upgrade_4(Text txt, Image img, int Count_Souls)
    {
        int Souls_after_Upgrade;
        txt.text = "Ghosty (4)"; //set Text of Button to ...
        img.sprite = Sprite_Upgrade_4; //change image

        Souls_after_Upgrade = Count_Souls - 10000;
        Souls.text = Souls_after_Upgrade.ToString();
    }

    void Upgrade_5(Text txt, Image img, int Count_Souls)
    {
        int Souls_after_Upgrade;
        txt.text = "Ghosty (5)"; //set Text of Button to ...
        img.sprite = Sprite_Upgrade_5; //change image

        Souls_after_Upgrade = Count_Souls - 20000;
        Souls.text = Souls_after_Upgrade.ToString();
    }
