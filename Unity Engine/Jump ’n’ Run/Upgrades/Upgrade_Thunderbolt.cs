...
public class Upgrade_Thunderbolt : MonoBehaviour
{
    ...
    void Upgrade_1(Text txt, Image img, int Count_Souls)
    {
        ...
        txt.text = "Blitzschlag (1)"; //set Text of Button to ...
    ...
    {
        int Souls_after_Upgrade;
        txt.text = "Blitzschlag (2)"; //set Text of Button to ...
