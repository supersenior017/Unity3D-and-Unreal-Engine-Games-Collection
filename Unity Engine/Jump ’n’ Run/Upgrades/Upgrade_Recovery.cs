...
public class Upgrade_Recovery : MonoBehaviour
{
    ...
    void Upgrade_1(Text txt, Image img, int Count_Souls)
    {
        ...
        txt.text = "Wiederherstellung (1)"; //set Text of Button to ...
    ...
    {
        int Souls_after_Upgrade;
        txt.text = "Wiederherstellung (2)"; //set Text of Button to ...
