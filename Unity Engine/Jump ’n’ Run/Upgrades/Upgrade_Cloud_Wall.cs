...
public class Upgrade_Cloud_Wall : MonoBehaviour
{
    ...
    void Upgrade_1(Text txt, Image img, int Count_Souls)
    {
        ...
        txt.text = "Wolkenmauer (1)"; //set Text of Button to ...
    ...
    {
        int Souls_after_Upgrade;
        txt.text = "Wolkenmauer (2)"; //set Text of Button to ...
