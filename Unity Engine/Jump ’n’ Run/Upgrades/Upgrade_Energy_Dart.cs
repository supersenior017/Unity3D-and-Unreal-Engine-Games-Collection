...
public class Upgrade_Energy_Dart : MonoBehaviour
{
    ...
    void Upgrade_1(Text txt, Image img, int Count_Souls)
    {
        ...
        txt.text = "Energiepfeil (1)"; //set Text of Button to ...
    ...
    {
        int Souls_after_Upgrade;
        txt.text = "Energiepfeil (2)"; //set Text of Button to ...
